            ...
            {error ? (
                ...
                <div className="space-y-4">
                    {posts.map((post) => (
                        <article
                            key={post.id}
                            className="rounded-lg border p-5 text-[var(--text)]"
                        >
                            <div className="flex items-start justify-between gap-4 text-[var(--text)]">
                                <div>
                                    <h2 className="text-xl font-semibold text-[var(--text)]">{post.title}</h2>
